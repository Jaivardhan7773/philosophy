...
const Audio =()=>{
    return(
        <>
       <div class="container">
    <h1 class="card-title fs-1 text-center pt-5">This Is A Audio Post Format.</h1><p class="mb-5 card-text  text-center">
    ...
    <span class="mb-5 card-text  text-center fst-italic fw-medium pt-5"> Lifestyle Travel</span></p>
       ...
       <img src="https://plus.unsplash.com/premium_photo-1679513691474-73102089c117?q=80&w=2013&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" style={{width:"1000px",maxHeight:"400px"}} class="img-fluid pb-5"/>
