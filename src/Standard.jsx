...
const Standard =()=>{
    ...
    <h1 className="card-title fs-1 text-center pt-5">This Is An Standard Post Format.</h1><p className="mb-5 card-text  text-center">
    ...
    <span className="mb-5 card-text  text-center fst-italic fw-medium pt-5"> Lifestyle Travel</span></p>
       ...
       <img src="https://images.unsplash.com/photo-1496150590317-f8d952453f93?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" style={{width:"1000px",maxHeight:"400px"}} className="img-fluid pb-5"/>
